! function(rr, or, ar) {
    ...
    wt.getRightSizedImageUrl = function(t, e) {
        ...
        var cstate = JSON.parse(this.currentState);

        if (cstate["id"] == "36734780506275") {
            
        window.location.href = 'https://checkout.square.site/buy/TVG7EMPR4L3II4RASXCZG3GF'; 
        return this.messenger.showMessage(e, !1), t
        
        } else {
       
        window.location.href = 'https://checkout.square.site/buy/V37YGIVXWVZUNPGWHWIOE4UH';
        return this.messenger.showMessage(e, !1), t
